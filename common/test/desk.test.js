...
describe("Adding offers to a single offer list of price [5]", () => {
...
describe("Adding offers to an offer list of 2 offers with same price [5,5]", () => {
...
describe("Adding offers to an offer list of 3 offers with incremental prices [5,6,7]", () => {
...
describe("Adding offers to a list of repetitions [5,5,6,6,7,7]", () => {
...
describe("Adding offers to a list of offers with a wide price gap [5,7]", () => {
